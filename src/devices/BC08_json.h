...
/*R""""(
{
   ...
   "model_id":"KSensor",
   "tag":"0708",
   "cond":["uuid", "index", 0, "feaa", "&", "svd", "=", 26, "index", 0, "21010b", "|", "svd", "=", 26, "index", 0, "21000b"],
   "properties":{
      ".cal":{
