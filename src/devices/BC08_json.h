...
/*R""""(
{
   ...
   "model_id":"KSensor",
   "tag":"0708",
   "condition":["uuid", "index", 0, "feaa", "&", "servicedata", "=", 26, "index", 0, "21010b", "|", "servicedata", "=", 26, "index", 0, "21000b"],
   "properties":{
      ".cal":{
