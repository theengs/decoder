...
/*R""""(
{
   ...
   "model_id":"CGC1/CGD1",
   "tag":"01",
   "cond":["servicedata", "=", 34, "index", 2, "0c", "|", "servicedata", "=", 34, "index", 2, "1e", "&", "uuid", "index", 0, "fdcd"],
   "properties":{
      "tempc":{
