...
const char* _CGDK2_json_STOCK = "{\"brand\":\"Qingping\",\"model\":\"TH Lite\",\"model_id\":\"CGDK2\",\"tag\":\"01\",\"cond\":[\"svd\",\"=\",34,\"index\",2,\"10\",\"&\",\"uuid\",\"index\",0,\"fdcd\"],\"properties\":{\"tempc\":{\"decoder\":[\"vfhd\",\"svd\",20,4,true],\"post_proc\":[\"/\",10]},\"hum\":{\"decoder\":[\"vfhd\",\"svd\",24,4,true,false],\"post_proc\":[\"/\",10]},\"batt\":{\"decoder\":[\"vfhd\",\"svd\",32,2,false]},\"mac\":{\"decoder\":[\"revmfhd\",\"svd\",4]}}}";
/*R""""(
{
   "brand":"Qingping",
   "model":"TH Lite",
   "model_id":"CGDK2",
   "tag":"01",
   "cond":["svd", "=", 34, "index", 2, "10", "&", "uuid", "index", 0, "fdcd"],
   "properties":{
      "tempc":{
...
/* R""""(
{
   ...
   "tag":"0102",
   "cond":["svd", "=", 26, "&", "uuid", "index", 0, "181a", "&", "name", "index", 0, "CGDK"],
   "properties":{
      "tempc":{
...
// PVVX
const char* _CGDK2_json_PVVX = "{\"brand\":\"ClearGrass/Qingping\",\"model\":\"TH Lite\",\"model_id\":\"CGDK2_PVVX\",\"tag\":\"0102\",\"cond\":[\"svd\",\"=\",30,\"&\",\"uuid\",\"index\",0,\"181a\",\"&\",\"name\",\"index\",0,\"CGD\"],\"properties\":{\"tempc\":{\"decoder\":[\"vfhd\",\"svd\",12,4,true],\"post_proc\":[\"/\",100]},\"hum\":{\"decoder\":[\"vfhd\",\"svd\",16,4,true],\"post_proc\":[\"/\",100]},\"batt\":{\"decoder\":[\"vfhd\",\"svd\",24,2,false]},\"volt\":{\"decoder\":[\"vfhd\",\"svd\",20,4,true],\"post_proc\":[\"/\",1000]},\"mac\":{\"decoder\":[\"revmfhd\",\"svd\",0]}}}";
/* R""""(
{
   "brand":"ClearGrass/Qingping",
   "model":"TH Lite",
   "model_id":"CGDK2_PVVX",
   "tag":"0102",
   "cond":["svd", "=", 30, "&", "uuid", "index", 0, "181a", "&", "name", "index", 0, "CGD"],
   "properties":{
      "tempc":{
