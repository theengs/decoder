...
/*R""""(
{
   ...
   "tag":"05",
   "cond":["svd", "index", 1, "32", "|", "svd", "index", 1, "3a", "|", "svd", "index", 1, "72", "|", "svd", "index", 1, "7a", "&", "svd", "=", 26, "&", "uuid", "contain", "181b"],
   "properties":{
      "weighing_mode":{
