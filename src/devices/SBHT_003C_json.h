...
/*R""""(
{
   ...
   "properties":{
      ...
      "tempc":{
         ...
         "decoder":["vfhd", "servicedata", 16, 4, true, true],
         "post_proc":["/", 10]
      },
      "_tempc":{
