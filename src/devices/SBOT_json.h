...
/*R""""(
{
   ...
   "model_id":"W340001X",
   "tag":"0102", 
   "cond":["svd", "=", 6, "index", 0, "77", "&", "uuid", "index", 0, "fd3d", "&", "mfd", "=", 28],
   "properties":{
      ".cal":{
...
const char* _SBOT_json_S = "{\"brand\":\"SwitchBot\",\"model\":\"Outdoor Meter\",\"model_id\":\"W340001X\",\"tag\":\"0100\",\"cond\":[\"svd\",\"=\",6,\"index\",0,\"77\",\"&\",\"name\",\"index\",0,\"WoIOSensorTH\"],\"properties\":{\"batt\":{\"decoder\":[\"vfhd\",\"svd\",4,2,false,false],\"post_proc\":[\"&\",127]}}}";
/*R""""(
{
   "brand":"SwitchBot",
   "model":"Outdoor Meter",
   "model_id":"W340001X",
   "tag":"0100", 
   "cond":["svd", "=", 6, "index", 0, "77", "&", "name", "index", 0, "WoIOSensorTH"],
   "properties":{
      "batt":{
         "decoder":["vfhd", "svd", 4, 2, false, false],
         "post_proc":["&", 127]
