...
/*R""""(
{
   ...
   "model_id":"K6P",
   "tag":"01",
   "cond":["svd", "=", 18, "index", 0, "210107", "&", "uuid", "index", 0, "feaa"],
   "properties":{
      ".cal":{
