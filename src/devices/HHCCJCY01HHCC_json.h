const char* _HHCCJCY01HHCC_json = "{\"brand\":\"Xiaomi/VegTrug\",\"model\":\"MiFlora\",\"model_id\":\"HHCCJCY01HHCC\",\"tag\":\"09\",\"cond\":[\"svd\",\"ind\",4,\"9800\",\"|\",\"svd\",\"ind\",4,\"bc03\",\"&\",\"uuid\",\"ind\",0,\"fe95\",\"&\",\"svd\",\">=\",32],\"properties\":{\"tempc\":{\"cond\":[\"svd\",24,\"0410\"],\"decoder\":[\"vfhd\",\"svd\",30,4,true],\"post_proc\":[\"/\",10]},\"moi\":{\"cond\":[\"svd\",24,\"0810\"],\"decoder\":[\"vfhd\",\"svd\",30,2,false]},\"lux\":{\"cond\":[\"svd\",24,\"0710\"],\"decoder\":[\"vfhd\",\"svd\",30,6,true]},\"fer\":{\"cond\":[\"svd\",24,\"0910\"],\"decoder\":[\"vfhd\",\"svd\",30,4,true]},\"mac\":{\"decoder\":[\"revmfhd\",\"svd\",10]}}}";
/*R""""(
{
   ...
   "tag":"09",
   "cond":["svd", "ind", 4, "9800", "|", "svd", "ind", 4, "bc03", "&", "uuid", "ind", 0, "fe95", "&", "svd", ">=", 32],
   "properties":{
      "tempc":{
         "cond":["svd", 24, "0410"],
