...
/*R""""(
{
   ...
   "model_id":"H5055",
   "tag":"0301",
   "cond":["manufacturerdata", "index", 12, "06", "|", "manufacturerdata", "index", 12, "20", "|", "manufacturerdata", "index", 12, "22", "&", "manufacturerdata", "=", 44, "index", 40, "0000", "|", "manufacturerdata", "=", 41, "index", 40, "0"],
   "properties":{
      "tempc1":{
