...
/*R""""(
{
   ...
   "model_id":"W270160X",
   "tag":"0d22",
   "cond":["uuid", "index", 0, "0d00", "|", "uuid", "index", 0, "fd3d", "&", "servicedata", "=", 6, "index", 0, "78", "&", "manufacturerdata", ">=", 24, "index", 0, "6909"],
   "properties":{
      "open":{
