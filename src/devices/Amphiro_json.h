const char* _AMPHIRO_json = "{\"brand\":\"Oras\",\"model\":\"Hydractiva Digital\",\"model_id\":\"ADHS\",\"tag\":\"0c01\",\"cond\":[\"mfd\",\"=\",42,\"ind\",0,\"eefa\"],\"properties\":{\"session\":{\"decoder\":[\"vfhd\",\"mfd\",4,6,false,false]},\"seconds\":{\"decoder\":[\"vfhd\",\"mfd\",10,4,false,false]},\"litres\":{\"decoder\":[\"vfhd\",\"mfd\",20,6,false,false],\"post_proc\":[\"/\",2560]},\"tempc\":{\"decoder\":[\"vfhd\",\"mfd\",26,2,false,false]},\"energy\":{\"decoder\":[\"vfhd\",\"mfd\",28,4,false,false],\"post_proc\":[\"/\",100]}}}";
/*R""""(
{
   "brand":"Oras",
