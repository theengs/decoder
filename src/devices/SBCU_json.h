...
/*R""""(
{
   ...
   "model_id":"W070160X",
   "tag":"0d22",
   "cond":["svd", "=", 10, "index", 0, "63", "|", "svd", "=", 12, "index", 0, "63", "|", "svd", "=", 12, "index", 0, "7b", "&", ["uuid", "index", 0, "0d00", "|", "uuid", "index", 0, "fd3d"]],
   "properties":{
      "moving":{
