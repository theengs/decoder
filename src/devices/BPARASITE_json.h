...
/* R""""(
{
   ...
   "model_id":"BPv1.0-1.2",
   "tag":"0904",
   "cond":["svd", ">=", 32, "index", 0, "1", "|", "svd", ">=", 32, "index", 0, "2", "&", "uuid", "index", 0, "181a"],
   "properties":{
      "tempc":{
         "cond":["svd", 0, "1"],
