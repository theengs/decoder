...
const char _MS_CDP_json_props[] PROGMEM = "{\"properties\":{\"device\":{\"unit\":\"string\",\"name\":\"device type\"},\"salt\":{\"unit\":\"hex\",\"name\":\"salt\"},\"hash\":{\"unit\":\"hex\",\"name\":\"device hash\"}}}";
/*R""""(
{
   "properties":{
      "device":{
