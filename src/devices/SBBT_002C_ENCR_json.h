const char* _SBBT_002C_ENCR_json = "{\"brand\":\"Shelly\",\"model\":\"ShellyBLU Button1 encrypted\",\"model_id\":\"SBBT_002C_ENCR\",\"tag\":\"110602\",\"cond\":[\"svd\",\"index\",0,\"41\",\"|\",\"svd\",\"index\",0,\"45\",\"&\",\"uuid\",\"index\",0,\"fcd2\",\"&\",\"name\",\"index\",0,\"SBBT-\"],\"properties\":{\"cipher\":{\"decoder\":[\"sfhd\",\"svd\",2,12]},\"ctr\":{\"decoder\":[\"sfhd\",\"svd\",14,8]},\"mic\":{\"decoder\":[\"sfhd\",\"svd\",22,8]},\"mac\":{\"cond\":[\"mfd\",\"=\",30],\"decoder\":[\"revmfhd\",\"mfd\",18]}}}";
/*R""""(
{
   "brand":"Shelly",
   ...
   "tag":"110602",
   "cond":["svd", "index", 0, "41", "|", "svd", "index", 0, "45", "&", "uuid", "index", 0, "fcd2", "&", "name", "index", 0, "SBBT-"],
   "properties":{
      "cipher":{
